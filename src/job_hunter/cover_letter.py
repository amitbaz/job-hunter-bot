...
def _build_cover_letter_prompt(job: Job, evaluation: Evaluation, profile: str, template: str, today: date) -> str:
...
NEVER invent facts about the candidate. Only use what is stated in the candidate profile below.
...
def generate_cover_letter(
    ...
    text = gemini.generate_text(_build_cover_letter_prompt(job, evaluation, profile, template, today))
    text = text.strip()
